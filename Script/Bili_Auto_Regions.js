...
async function SwitchRegion(title, url, body) {
	const Group = $.read('BiliArea_Policy') || '📺 CNTV'; //Your blibli policy group name.
	...
	const DF = $.read('BiliArea_DF') || '🇨🇳 Taiwan'; //Sub-policy name used after region is blocked(e.g. url 404)
